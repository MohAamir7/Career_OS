        ...
        <div className="space-y-6 xl:col-span-2">
            ...
            <div className="flex flex-col gap-6 sm:flex-row sm:items-start">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex flex-col justify-between gap-3 sm:flex-row">
                  ...
                  <button className="inline-flex w-fit items-center gap-2 rounded-lg border border-slate-200 px-4 py-2 text-sm font-medium text-slate-700 transition hover:bg-slate-50">
                    {/* <Pencil size={16} /> */}
                    Edit Profile
                  </button>
                </div>
                ...
                <p className="mt-5 max-w-3xl text-sm leading-6 text-slate-600">
                  ...
                  user-friendly web applications. Interested in solving complex
                  problems and continuously improving technical and
            ...
            <div className="mt-6 flex flex-col gap-6 sm:flex-row sm:items-center">
              ...
              <div className="grid flex-1 grid-cols-2 gap-4 sm:grid-cols-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xl font-bold text-emerald-600">78</p>
                </div>

                <div>
                  <p className="text-xs text-slate-500">Medium</p>

                  <p className="mt-1 text-xl font-bold text-amber-500">42</p>
                </div>

                <div>
                  <p className="text-xs text-slate-500">Hard</p>

                  <p className="mt-1 text-xl font-bold text-red-500">8</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5">
              ...
              <p className="mt-1 text-sm text-slate-500">University Name</p>

              <p className="mt-2 text-xs text-slate-400">2022 — 2026</p>
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 rounded-xl border border-dashed border-slate-300 bg-slate-50 p-6 text-center">
              ...
              <h3 className="mt-3 text-sm font-semibold">Resume.pdf</h3>

              <p className="mt-1 text-xs text-slate-500">
                Last updated recently
              </p>

              <button className="mt-4 inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-indigo-700">
                <Download size={16} />
                Download Resume
              </button>
            </div>
